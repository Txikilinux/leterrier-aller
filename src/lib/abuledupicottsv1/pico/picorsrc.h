...
void picorsrc_disposeResourceManager(picoos_MemoryManager mm, picorsrc_ResourceManager * );
...
pico_status_t picorsrc_loadResource(picorsrc_ResourceManager ,
        picoos_char * fileName, picorsrc_Resource * resource);

/* unload resource file. (warn if resource file is busy) */
pico_status_t picorsrc_unloadResource(picorsrc_ResourceManager , picorsrc_Resource * rsrc);


pico_status_t picorsrc_createDefaultResource(picorsrc_ResourceManager  /*,
...
pico_status_t picorsrc_releaseVoiceDefinition(picorsrc_ResourceManager ,
        picoos_char * voiceName);

pico_status_t picorsrc_addResourceToVoiceDefinition(picorsrc_ResourceManager ,
...
pico_status_t picorsrc_createVoice(picorsrc_ResourceManager , const picoos_char * voiceName, picorsrc_Voice * voice);

/* dispose voice. the corresponding lock counts are decremented. */
pico_status_t picorsrc_releaseVoice(picorsrc_ResourceManager , picorsrc_Voice * voice);
