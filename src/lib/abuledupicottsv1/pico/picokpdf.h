...
pico_status_t picokpdf_specializePdfKnowledgeBase(picoknow_KnowledgeBase ,
...
picokpdf_PdfDUR picokpdf_getPdfDUR(picoknow_KnowledgeBase );
picokpdf_PdfMUL picokpdf_getPdfMUL(picoknow_KnowledgeBase );
picokpdf_PdfPHS picokpdf_getPdfPHS(picoknow_KnowledgeBase );
