...
pico_status_t picokdt_specializeDtKnowledgeBase(picoknow_KnowledgeBase ,
...
picokdt_DtPosP picokdt_getDtPosP(picoknow_KnowledgeBase );
picokdt_DtPosD picokdt_getDtPosD(picoknow_KnowledgeBase );
picokdt_DtG2P  picokdt_getDtG2P (picoknow_KnowledgeBase );
picokdt_DtPHR  picokdt_getDtPHR (picoknow_KnowledgeBase );
picokdt_DtACC  picokdt_getDtACC (picoknow_KnowledgeBase );
picokdt_DtPAM  picokdt_getDtPAM (picoknow_KnowledgeBase );
...
*/
picoos_uint8 picokdt_dtPosPconstructInVec(const picokdt_DtPosP ,
...
/* classify a previously constructed input vector using tree 'this'
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPosPclassify(const picokdt_DtPosP );

/* decompose the tree output and return the class in dtres
   dtres:         POS or POSgroup ID classification result
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPosPdecomposeOutClass(const picokdt_DtPosP ,
...
*/
picoos_uint8 picokdt_dtPosDconstructInVec(const picokdt_DtPosD ,
...
/* classify a previously constructed input vector using tree 'this'
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPosDclassify(const picokdt_DtPosD ,
...
/* decompose the tree output and return the class in dtres
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPosDdecomposeOutClass(const picokdt_DtPosD ,
                                             picokdt_classify_result_t *dtres);

/* convert (unique) POS index into corresponding tree output index */
picoos_uint8 picokdt_dtPosDreverseMapOutFixed(const picokdt_DtPosD ,
...
/* construct a G2P input vector (run in right-to-left mode)
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtG2PconstructInVec(const picokdt_DtG2P ,
                                         const picoos_uint8 *graph,
                                         const picoos_uint16 graphlen,
...
/* classify a previously constructed input vector using tree 'this'
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtG2Pclassify(const picokdt_DtG2P ,
                                   picoos_uint16 *treeout);
...
/* decompose the tree output and return the class vector in dtvres
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtG2PdecomposeOutClass(const picokdt_DtG2P ,
...
/* construct a PHR input vector (run in right-to-left mode)
   ...
   note:            use PICOKDT_EPSILON for att values outside context
*/
picoos_uint8 picokdt_dtPHRconstructInVec(const picokdt_DtPHR ,
...
/* classify a previously constructed input vector using tree 'this'
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPHRclassify(const picokdt_DtPHR );

/* decompose the tree output and return the class vector in dtres
   dtres:         phrasing classification result
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPHRdecomposeOutClass(const picokdt_DtPHR ,
                                            picokdt_classify_result_t *dtres);
...
*/
picoos_uint8 picokdt_dtACCconstructInVec(const picokdt_DtACC ,
                                         const picoos_uint8 pre2,
                                         const picoos_uint8 pre1,
                                         const picoos_uint8 src,
                                         const picoos_uint8 fol1,
...
/* classify a previously constructed input vector using tree 'this'
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtACCclassify(const picokdt_DtACC ,
                                   picoos_uint16 *treeout);
...
/* decompose the tree output and return the class vector in dtres
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtACCdecomposeOutClass(const picokdt_DtACC ,
                                            picokdt_classify_result_t *dtres);
...
/* construct a Pam input vector and store the tree-specific encoded
   ...
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPAMconstructInVec(const picokdt_DtPAM ,
...
/* classify a previously constructed input vector using tree 'this'
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPAMclassify(const picokdt_DtPAM );

/* decompose the tree output and return the class in dtres
   dtres:         phones vector classification result
   returns:       TRUE if okay, FALSE otherwise
*/
picoos_uint8 picokdt_dtPAMdecomposeOutClass(const picokdt_DtPAM ,
                                            picokdt_classify_result_t *dtres);
