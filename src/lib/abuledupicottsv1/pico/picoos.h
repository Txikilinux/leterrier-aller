...
void picoos_disposeCommon(picoos_MemoryManager mm, picoos_Common * );
...
void * picoos_allocate(picoos_MemoryManager , picoos_objsize_t byteSize);
void picoos_deallocate(picoos_MemoryManager , void * * adr);
 ...
 * the error! */
pico_status_t picoos_emRaiseException(picoos_ExceptionManager ,
        pico_status_t exceptionCode, picoos_char * baseMessage, picoos_char * fmt, ...);

pico_status_t picoos_emGetExceptionCode(picoos_ExceptionManager );

void picoos_emGetExceptionMessage(picoos_ExceptionManager , picoos_char * msg, picoos_uint16 maxsize);

void picoos_emRaiseWarning(picoos_ExceptionManager ,
        pico_status_t warningCode, picoos_char * baseMessage, picoos_char * fmt, ...);

picoos_uint8 picoos_emGetNumOfWarnings(picoos_ExceptionManager );

pico_status_t picoos_emGetWarningCode(picoos_ExceptionManager , picoos_uint8 warnNum);

void picoos_emGetWarningMessage(picoos_ExceptionManager , picoos_uint8 warnNum, picoos_char * msg, picoos_uint16 maxsize);
