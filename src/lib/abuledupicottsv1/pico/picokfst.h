...
pico_status_t picokfst_specializeFSTKnowledgeBase(picoknow_KnowledgeBase ,
...
picokfst_FST picokfst_getFST(picoknow_KnowledgeBase );
...
picoos_uint8 picokfst_kfstGetTransductionMode(picokfst_FST );

/* returns number of states and number of pair classes in FST;
   legal states are 1..nrStates, legal classes are 1..nrClasses */
void picokfst_kfstGetFSTSizes (picokfst_FST , picoos_int32 *nrStates, picoos_int32 *nrClasses);
...
void picokfst_kfstStartPairSearch (picokfst_FST , picokfst_symid_t inSym,
...
void picokfst_kfstGetNextPair (picokfst_FST , picoos_int32 * searchState,
...
void picokfst_kfstGetTrans (picokfst_FST , picokfst_state_t startState, picokfst_class_t transClass,
...
void picokfst_kfstStartInEpsTransSearch (picokfst_FST , picokfst_state_t startState,
...
void picokfst_kfstGetNextInEpsTrans (picokfst_FST , picoos_int32 * searchState,
...
picoos_bool picokfst_kfstIsAcceptingState (picokfst_FST , picokfst_state_t state);
