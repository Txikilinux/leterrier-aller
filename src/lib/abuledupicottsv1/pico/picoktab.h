...
pico_status_t picoktab_specializeIdsKnowledgeBase(picoknow_KnowledgeBase ,
                                                  picoos_Common common);

picoktab_FixedIds picoktab_getFixedIds(picoknow_KnowledgeBase );
...
/* to be used by picorsrc only */
pico_status_t picoktab_specializeGraphsKnowledgeBase(picoknow_KnowledgeBase ,
                                                     picoos_Common common);
...
picoos_bool  picoktab_getIntPropTokenType(const picoktab_Graphs ,
                                           picoos_uint32 graphsOffset,
                                           picoos_uint8 *stokenType);
picoos_bool  picoktab_getIntPropTokenSubType(const picoktab_Graphs ,
                                              picoos_uint32 graphsOffset,
                                              picoos_int8 *stokenSubType);
picoos_bool  picoktab_getIntPropValue(const picoktab_Graphs ,
                                      picoos_uint32 graphsOffset,
                                      picoos_uint32 *value);
picoos_bool  picoktab_getStrPropLowercase(const picoktab_Graphs ,
                                          picoos_uint32 graphsOffset,
                                          picoos_uchar *lowercase);
picoos_bool  picoktab_getStrPropGraphsubs1(const picoktab_Graphs ,
                                           picoos_uint32 graphsOffset,
                                           picoos_uchar *graphsubs1);
picoos_bool  picoktab_getStrPropGraphsubs2(const picoktab_Graphs ,
                                           picoos_uint32 graphsOffset,
                                           picoos_uchar *graphsubs2);
picoos_bool  picoktab_getIntPropPunct(const picoktab_Graphs ,
                                      picoos_uint32 graphsOffset,
                                      picoos_uint8 *info1,
                                      picoos_uint8 *info2);

picoos_uint16 picoktab_graphsGetNumEntries(const picoktab_Graphs );
void picoktab_graphsGetGraphInfo(const picoktab_Graphs ,
...
/* to be used by picorsrc only */
pico_status_t picoktab_specializePhonesKnowledgeBase(picoknow_KnowledgeBase ,
                                                     picoos_Common common);

typedef struct picoktab_phones *picoktab_Phones;

/* return kb Phones for usage in PU */
picoktab_Phones picoktab_getPhones(picoknow_KnowledgeBase );

/* check if 'ch' has a property, return non-zero if 'ch' has the
   property, 0 otherwise */
picoos_uint8 picoktab_hasVowelProp(const picoktab_Phones ,
                                   const picoos_uint8 ch);
picoos_uint8 picoktab_hasDiphthProp(const picoktab_Phones,
                                    const picoos_uint8 ch);
picoos_uint8 picoktab_hasGlottProp(const picoktab_Phones ,
                                   const picoos_uint8 ch);
picoos_uint8 picoktab_hasNonsyllvowelProp(const picoktab_Phones,
                                          const picoos_uint8 ch);
picoos_uint8 picoktab_hasSyllconsProp(const picoktab_Phones ,
                                      const picoos_uint8 ch);
...
picoos_bool picoktab_isSyllCarrier(const picoktab_Phones ,
                                    const picoos_uint8 ch);
...
/* some properties can be assigned to a single sym only, check if 'ch'
   ...
   otherwise */
picoos_bool picoktab_isPrimstress(const picoktab_Phones ,
                                   const picoos_uint8 ch);
picoos_bool picoktab_isSecstress(const picoktab_Phones ,
                                  const picoos_uint8 ch);
picoos_bool picoktab_isSyllbound(const picoktab_Phones ,
                                  const picoos_uint8 ch);
picoos_bool picoktab_isWordbound(const picoktab_Phones ,
                                  const picoos_uint8 ch);
picoos_bool picoktab_isPause(const picoktab_Phones ,
                              const picoos_uint8 ch);

/* get specific sym values */
picoos_uint8 picoktab_getPrimstressID(const picoktab_Phones );
picoos_uint8 picoktab_getSecstressID(const picoktab_Phones );
picoos_uint8 picoktab_getSyllboundID(const picoktab_Phones );
picoos_uint8 picoktab_getWordboundID(const picoktab_Phones );
picoos_uint8 picoktab_getPauseID(const picoktab_Phones );
...
/* to be used by picorsrc only */
pico_status_t picoktab_specializePosKnowledgeBase(picoknow_KnowledgeBase ,
                                                  picoos_Common common);
...
picoktab_Pos picoktab_getPos(picoknow_KnowledgeBase );

/* returns TRUE if 'pos' is the ID of a unique (ie. non-combined) POS,
   returns FALSE otherwise */
picoos_bool picoktab_isUniquePos(const picoktab_Pos ,
...
picoos_bool picoktab_isPartOfPosGroup(const picoktab_Pos ,
                                       const picoos_uint8 pos,
...
picoos_uint8 picoktab_getPosGroup(const picoktab_Pos ,
