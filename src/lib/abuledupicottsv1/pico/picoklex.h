...
pico_status_t picoklex_specializeLexKnowledgeBase(picoknow_KnowledgeBase ,
...
picoklex_Lex picoklex_getLex(picoknow_KnowledgeBase );
...
picoos_uint8 picoklex_lexLookup(const picoklex_Lex ,
...
picoos_uint8 picoklex_lexIndLookup(const picoklex_Lex ,
