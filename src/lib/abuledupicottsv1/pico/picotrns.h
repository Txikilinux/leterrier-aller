...
pico_status_t picotrns_disposeSimpleTransducer(picotrns_SimpleTransducer *,
        picoos_MemoryManager mm);

pico_status_t  picotrns_stInitialize(picotrns_SimpleTransducer transducer);

pico_status_t picotrns_stAddWithPlane(picotrns_SimpleTransducer , picoos_char * inStr, picoos_uint8 plane);

pico_status_t picotrns_stTransduce(picotrns_SimpleTransducer , picokfst_FST fst);
