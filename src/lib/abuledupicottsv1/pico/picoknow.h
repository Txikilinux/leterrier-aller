...
typedef pico_status_t (* picoknow_kbSubDeallocate) (register picoknow_KnowledgeBase , picoos_MemoryManager mm);
...
extern void picoknow_disposeKnowledgeBase(picoos_MemoryManager mm, picoknow_KnowledgeBase * );
