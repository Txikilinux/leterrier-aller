...
#ifndef EXERCICEPARAGRAPHESMELANGES_H
#define EXERCICEPARAGRAPHESMELANGES_H
...
class ExerciceParagraphesMelanges : public AbulEduCommonStatesV1, public AbulEduOutilsV1
{
    Q_OBJECT

public:
    ExerciceParagraphesMelanges(QWidget *parent = 0, QString repertoireBase = "");
    ~ExerciceParagraphesMelanges();

    static QMap<int, QString> takeParagraphs(const QString &unitPath, int exerciseNumber, AbulEduTextV1 *text);
protected:
...
//    QMap<int, QStringList> m_listeExo;
    ...
    QStringList m_listeParagraphes;
...
#endif // EXERCICEPARAGRAPHESMELANGES_H
