...
#define EXECNAME "leterrier-aller"
#define ICONNAME "leterrier-aller"
#define DIRNAME "aller"
#define APPNAME "Le Terrier d'AbulEdu - ALLER"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{E07C3F7A-215C-4EB4-834B-FCA58FC90358}
AppName={#APPNAME}
...
Source: "../src/data/dictionnaires/*.*"; DestDir: "{app}/data/dictionnaires"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "C:/code/codecs/opencodecs_0.85.17777.exe"; DestDir: "{tmp}"
; pour alacarte > 1.0.8
...
Filename: "{tmp}/opencodecs_0.85.17777.exe"; Parameters: "/S"
